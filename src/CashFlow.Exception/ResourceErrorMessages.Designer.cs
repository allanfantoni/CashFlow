...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string DATE_EXPENSES_CANNOT_BE_IN_THE_FUTURE {
            get {
                return ResourceManager.GetString("DATE_EXPENSES_CANNOT_BE_IN_THE_FUTURE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Payment type is invalid. Valid values are: Cash, Credit Card, Debit Card, Electronic Transfer..
        /// </summary>
